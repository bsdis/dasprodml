...
#
# Generated Wed Apr 26 16:56:58 2017 by generateDS.py version 2.25a.
#
# Command line options:
#   ('-o', 'dasprodml/FiberOpticalPath.py')
#   ('-s', 'dasprodml/FiberOpticalPathSub.py')
#   ('--super', 'DasAcquisition')
#   ('-m', '')
#
# Command line arguments:
#   ./energistics/prodml/v2.0/xsd_schemas/FiberOpticalPath.xsd
#
# Command line:
#   generateDS.py -o "dasprodml/FiberOpticalPath.py" -s "dasprodml/FiberOpticalPathSub.py" --super="FiberOpticalPath" -m ./energistics/prodml/v2.0/xsd_schemas/FiberOpticalPath.xsd
#
...
import dasprodml.FiberOpticalPath as supermod
...
class AbstractAttenuationMeasureSub(supermod.AbstractAttenuationMeasure):
    def __init__(self):
        super(AbstractAttenuationMeasureSub, self).__init__()
...
class AbstractCableSub(supermod.AbstractCable):
    def __init__(self):
        super(AbstractCableSub, self).__init__()
...
class AbstractFiberFacilitySub(supermod.AbstractFiberFacility):
    def __init__(self):
        super(AbstractFiberFacilitySub, self).__init__()
...
class CustomDataSub(supermod.CustomData):
...
class ExtensionNameValueSub(supermod.ExtensionNameValue):
...
class ObjectAliasSub(supermod.ObjectAlias):
...
class StringMeasureSub(supermod.StringMeasure):
    def __init__(self, uom=None, valueOf_=None):
...
class EpcExternalPartReferenceSub(supermod.EpcExternalPartReference):
...
class ExternalDatasetSub(supermod.ExternalDataset):
...
class ExternalDatasetPartSub(supermod.ExternalDatasetPart):
    def __init__(self, Count=None, PathInExternalFile=None, StartIndex=None, EpcExternalPartReference=None):
        super(ExternalDatasetPartSub, self).__init__(Count, PathInExternalFile, StartIndex, EpcExternalPartReference, )
...
def parse(inFilename, silence=False):
    ...
    if rootClass is None:
        rootTag = 'AbstractAttenuationMeasure'
        rootClass = supermod.AbstractAttenuationMeasure
